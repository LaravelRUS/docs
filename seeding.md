# Laravel 8 · База данных · Наполнение фиктивными данными
...
> {tip} При наполнении базы данных автоматически отключается защита [массового присвоения](eloquent#mass-assignment).
