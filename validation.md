...
Затем вам нужно зарегистрировать это расширение валидации. Сделать это можно, например, в вашем [сервис-провайдере](/docs/5.0/ioc#service-providers) или в ваших [старт-файлах](/docs/5.0/lifecycle#start-files).
