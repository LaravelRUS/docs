git 2dd3937387bcac0d31280b52dab55156caa021be
...
Значение поля должно быть менее _value_. Строки, числа и файлы трактуются аналогично правилу `size`.
...
Затем вам нужно зарегистрировать это расширение валидации. Сделать это можно, например, в вашем [сервис-провайдере](/docs/ioc#service-providers) или в ваших [старт-файлах](/docs/lifecycle#start-files).
