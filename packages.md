...
Вы можете легко создавать и выполнять [миграции](/docs/4.1/migrations) для любого из ваших пакетов. Для создания миграции в `workbench` используется команда `--bench` option:
