git 6a81177cb7a80f95cfbb5197a1342d558ed99a2d
...
Вы также можете зарегистрировать обработчик, который запустится в момент, когда фреймворк определит, какой роут нужно задействовать на пришедший запрос.
