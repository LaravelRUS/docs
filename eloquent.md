git 18e0cee20cf4decfeb6ec57aba5c1bda0f7bb6a7
...
Когда вы удаляете модель с включенным `softDelete`, она на самом деле остаётся в базе данных, однако устанавливается её поле `deleted_at`. Для включения псевдоудалений добавьте в модель трейт `SoftDeletingTrait`:
...
Если наименование столбцов у вас в таблице отличается от общепринятого, вы можете указать их названия явно:
