...
Глобальные условия запросов (global scores) добавляют во **все** запросы для данной модели определённые условия. Например, механизм псевдоудаления моделей в Laravel построен на механизме глобальных условий - в можели с функцией псевдоудаления ставится условие отфильтровывать все псевдоудалённые значения. 
