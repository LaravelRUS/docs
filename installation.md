git 2eb1334a8c113491e4ccaa3034bb8e3e7706100a
...
После вам будет необходимо определить [среду выполнения](/docs/4.1/configuration#environment-configuration) и отредактировать конфиг-файлы фреймворка - например, разрешить отображение ошибок для вашей среды выполнения (параметр `debug` в конфиге app.php).
