...
Как было упомянуто выше, при помощи функции-хэлпера `collect` мы создаём новый `Illuminate\Support\Collection` экземпляр для данного массива. Таким образом, создать коллекцию становиться очень просто:
