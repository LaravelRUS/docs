git c0bcbe6b58ff0127631266697214c8e95eb3bb02
...
Подобно вызовам метода `where` в построителе запросов запросов, вы также можете явно указать оператор сравнения:
