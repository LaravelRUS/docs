...
> **Примечание** Для работы с вложенными вьюхами смотрите также `@include` шаблонизатора [Blade](/docs/4.2/template)	
...
Если вам больше нравится использовать классы (что позволит вам регистрировать несколько композеров в [IoC Container](/docs/4.2/ioc) и ресолвить нужный в сервис-провайдере), то вы можете сделать так:
...
Определения макросов ответов должны располагаться в одном из ваших [старт-файлов](/docs/4.2/lifecycle#start-files).
