...
[Фабрики модели](/docs/database-testing#defining-model-factories) Eloquent были полностью переписаны как фабрики на основе классов и улучшены для обеспечения "first-class" поддержки отношений. Например, `UserFactory`, включенный в Laravel, написан так:
...
Переписанные фабрики Laravel содержат гораздо больше функций, которые, как мы думаем, вам понравятся. Чтобы узнать больше о фабриках моделей, обратитесь к [документации по тестированию баз данных](/docs/database-testing#defining-model-factories).
...
Чтобы узнать больше о пакетной обработки заданий, обратитесь к [документации по очередям](/docs/queues#job-batching).
...
Чтобы узнать больше об ограничителях запросов, обратитесь к [документации по маршрутизации](/docs/routing#rate-limiting).
...
Чтобы узнать больше о компонентах Blade, обратитесь к [документации Blade](/docs/blade#components).
