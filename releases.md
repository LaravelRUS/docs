...
[Документация по контрактам](/docs/contracts).
...
Основной способ передачи классов для использования в вашем контроллере - указать их (type-hint) в аргументах конструктора вашего контроллера. Так как Laravel создает контроллеры и другие классы фреймворка при помощи [сервис-контейнера](/docs/container), он автоматически создает ожидаемые в аргументах конструктора классы и автоматически же подставляет их в вызов контроллера.
...
[Документация по событиям](/docs/events).
...
[Документация по командной шине](/docs/bus)
...
[Документация по периодическому запуску команд](/docs/artisan#scheduling-artisan-commands).
...
[Документация по настройке среды приложения](/docs/configuration#environment-configuration).
...
[Документация по Laravel Elixir](/docs/elixir).
...
[Документация по аутентификации через соцсети](/docs/authentication#social-authentication).
...
[Документация по Flysystem](/docs/filesystem).
...
[Документация по валидации в контроллерах](/docs/validation#controller-validation).
