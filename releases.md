...
[Документация по контрактам](/docs/master/contracts).
...
Основной способ передачи классов для использования в вашем контроллере - указать их (type-hint) в аргументах конструктора вашего контроллера. Так как Laravel создает контроллеры и другие классы фреймворка при помощи [IoC container](/docs/master/container), он автоматически создает ожидаемые в аргументах конструктора классы и автоматически же подставляет их в вызов контроллера.
...
[Документация по событиям](/docs/master/events).
...
[Документация по командной шине](/docs/master/bus)
...
[Документация по периодическому запуску команд](/docs/master/artisan#scheduling-artisan-commands).
...
[Документация по аутентификации через соцсети](/docs/master/authentication#social-authentication).
...
[Документация по Flysystem](/docs/master/filesystem).
...
[Документация по валидации в контроллерах](/docs/master/validation#controller-validation).
