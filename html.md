...
1. Flash-переменная сессии ([старый ввод](/docs/4.1/requests#old))
...
Урлы можно не только задавать явным образом, но и формировать исходя из имени роута назначения или названия экшна контроллера - см. [helpers](/docs/4.1/helpers#urls).
