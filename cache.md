...
- [Использование кэша](#cache-usage)
    ...
    - [Сохранение элементов в кэша](#storing-items-in-the-cache)
    - [Удаление элементов из кэша](#removing-items-from-the-cache)
- [Тэги кэша](#cache-tags)
    - [Сохранение элементов в кэша по тегам](#storing-tagged-cache-items)
...
Для получения дополнительной информации о настройке Redis, обратитесь к его документации [Laravel documentation page](/docs/{{version}}/redis#configuration).
