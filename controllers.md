...
[Посредники](/docs/middleware) могут быть привязаны к маршрутам следующим образом:
...
[Сервис-контейнер](/docs/container) используется для поиска и получения всех контроллеров.
За счёт этого вы можете указать любые зависимости в качестве аргументов конструктора вашего контроллера,
в том числе и любой [контракт](/docs/contracts):
...
> **Примечание:** Внедрение зависимостей в методы контроллера полностью дружат с механизмом [связанных моделей](/docs/routing#route-model-binding).
