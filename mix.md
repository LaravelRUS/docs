git e877592c03a40ee5d069b0fd52804faf379fceb0

---

# Компиляция JS и CSS (Mix)

- [Компиляция JS и CSS (Mix)](#компиляция-js-и-css-mix)
  - [Введение](#введение)
  - [Установка и настройка](#установка-и-настройка)
      - [Установка Node](#установка-node)
      - [Установка Laravel Mix](#установка-laravel-mix)
  - [Запуск Mix](#запуск-mix)
      - [Наблюдение за изменениями исходников](#наблюдение-за-изменениями-исходников)
  - [Работа с таблицами стилей](#работа-с-таблицами-стилей)
    - [Tailwind CSS](#tailwind-css)
    - [PostCSS](#postcss)
    - [Sass](#sass)
    - [Обработка URL](#обработка-url)
    - [Source maps CSS](#source-maps-css)
      - [Сопоставление стилей исходников](#сопоставление-стилей-исходников)
  - [Работа с JavaScript](#работа-с-javascript)
    - [Vue](#vue)
    - [React](#react)
    - [Извлечение сторонних библиотек](#извлечение-сторонних-библиотек)
    - [Пользовательская конфигурация Webpack](#пользовательская-конфигурация-webpack)
  - [Версионирование / очистка кеша](#версионирование--очистка-кеша)
      - [Корректировка базовых URL-адресов с помощью Mix](#корректировка-базовых-url-адресов-с-помощью-mix)
  - [Обновление контента с помощью Browsersync](#обновление-контента-с-помощью-browsersync)
...
Команда `init` сгенерирует файл `tailwind.config.js`. Раздел `content` этого файла позволяет вам настроить пути ко всем вашим шаблонам HTML, компонентам JavaScript и любым другим исходным файлам, которые содержат имена классов Tailwind, чтобы их можно было очистить:
...
После создания файла версионирования вы не узнаете его точное имя. Итак, вы должны использовать глобальную функцию Laravel `mix` в вашем [шаблоне](/docs/{{version}}/views) для загрузки хешированного ресурса. Глобальная функция `mix` фреймворка Laravel автоматически определит текущее имя хешированного файла:
