...
После создания файла версионирования вы не узнаете его точное имя. Итак, вы должны использовать глобальную функцию Laravel `mix` в вашем [шаблоне](/docs/{{version}}/views) для загрузки хэшированного ресурса. Глобальная функция `mix` фреймворка Laravel автоматически определит текущее имя хэшированного файла:
