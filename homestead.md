---
git: 14692ef6b5b6464ec0ecafbee2afeddb0d3ad483
---
...
Homestead поддерживает запуск нескольких версий PHP на одной виртуальной машине. Вы можете указать, какую версию PHP использовать для определенного сайта в файле `Homestead.yaml`. Доступные версии PHP: "5.6", "7.0", "7.1", "7.2", "7.3", "7.4", "8.0", "8.1" и "8.2" (по умолчанию):
