...
Laravel Elixir предоставляет простой и гибкий API для определения задач [Gulp](http://gulpjs.com) для вашего Laravel приложения. Elixir поддерживает несколько основных CSS и Javascript препроцессоров, и даже инструментов тестирования. Использование цепочки методов Elixir'a позволит вам легко определить ваши скрипты и стили. Например:
