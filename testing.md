# Laravel 8 · Тестирование · Начало работы
...
Чтобы сгенерировать новый тест, используйте команду `make:test` [Artisan](artisan). Эта команда поместит новый класс теста в каталог `tests/Feature` вашего приложения:
