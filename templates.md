git e3bbdc6971c52991e043ba9056bea7897225da0c
...
По умолчанию весь выводимый контент "эскейпится", т.е. все управляющие конструкции javascript и html показываются, вместо того, чтобы исполняться. Если вы хотите отменить это, выводите переменные в следующих тэгах, но будьте осторожны и не выводите в них контент, который мог изменить пользователь: 
