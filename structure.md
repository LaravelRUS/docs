---
git: c3fc92168a0dd2b8c97097eac073f766e3f9950c
---
...
> **Note**
> Новичок в Laravel? Посетите [Laravel Bootcamp](https://bootcamp.laravel.com) (английский язык), чтобы практически ознакомиться с фреймворком, в то время как мы проведем вас через процесс создания вашего первого приложения на Laravel.
...
Каталог `resources` содержит ваши [шаблоны](/docs/{{version}}/views), а также ваши необработанные, нескомпилированные ресурсы, например, JavaScript или CSS.
